...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGunMiniGolfCodedGameModeBase_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AGunMiniGolfCodedGameModeBase_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_AGunMiniGolfCodedGameModeBase()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AGunMiniGolfCodedGameModeBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AGunMiniGolfCodedGameModeBase, 3399758560);
